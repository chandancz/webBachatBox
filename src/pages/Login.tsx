...
const Login: React.FC = () => {
  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center px-4 py-8 md:py-16 ${themeClasses}`}
    >
      ...
      <div
        className={`w-full max-w-[95%] sm:max-w-md md:max-w-md lg:max-w-[460px]
              relative z-10 rounded-2xl border p-6 sm:p-8 
              max-h-[750px] lg:max-h-[600px] overflow-hidden 
              transition-all duration-300 hover:scale-[1.02] ${cardClasses}`}
      >
        {/* Header */}
