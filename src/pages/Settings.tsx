...
const Settings = () => {
  ...
  const PrivacyContent = () => (
    <div className="space-y-4">
      ...
      <div
        className={`prose transition-colors ${
      ...
      >
        ...
        <p className="mb-3">
          ...
          including account details and usage preferences.
        </p>
        <h4
          className={`font-semibold mt-4 mb-2 ${
            darkMode ? "text-gray-200" : "text-gray-800"
        ...
        <p className="mb-3">
          Your data is used solely to improve your experience and is never
  ...
  const AboutContent = () => (
    <div className="space-y-4">
      ...
      >
        <p className="mb-4">
          We're passionate about creating intuitive, user-friendly applications
          that make your digital life easier.
        </p>
        <h4
          className={`font-semibold mt-4 mb-2 ${
            darkMode ? "text-gray-200" : "text-gray-800"
        ...
        <p className="mb-3">
          To deliver exceptional digital experiences that prioritize user needs
          and satisfaction.
        </p>
        <h4
          className={`font-semibold mt-4 mb-2 ${
      ...
      >
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <a
              href="mailto:business@company.com"
              className="text-blue-500 hover:text-blue-600 font-medium"
            >
    ...
    <>
      ...
      >
        <div className="min-h-screen flex items-center justify-center p-4 lg:p-8">
          <div
            className={`w-full max-w-6xl transform transition-all duration-500 hover:scale-[1.02] ${
              darkMode
          ...
          >
            <div className="flex flex-col lg:flex-row min-h-[600px]">
              {/* Sidebar */}
              <div
                className={`lg:w-80 p-6 border-b lg:border-b-0 lg:border-r transition-colors ${
