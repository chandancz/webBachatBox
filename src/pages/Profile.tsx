...
import { Moon, Sun, Edit3, Save, X, Camera, User, Mail, Phone, Calendar, Lock, Eye, EyeOff } from "lucide-react";
...
const Profile: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen transition-all duration-500 ease-in-out ${themeClasses} ${isAnimating ? 'scale-95 opacity-50' : 'scale-100 opacity-100'}`}>
      {/* Theme Toggle */}
      <div className="absolute top-6 right-6 z-10">
        <Button
          ...
          className={`rounded-full p-3 transition-all duration-300 hover:scale-110 ${
            isDarkMode 
              ? "bg-gray-800/80 border-gray-600 hover:bg-gray-700 text-yellow-400" 
              : "bg-white/80 border-gray-200 hover:bg-gray-50 text-orange-500"
          }`}
        >
